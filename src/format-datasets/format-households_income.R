...
df_combined <- expand.grid(c('single', 'single-parent', 'couple with children', 'couple without children'),
                           ...
                           c('breadwinner_age_0_24', 'breadwinner_age_25_44', 'breadwinner_age_45_64', 'breadwinner_age_over_65'))
colnames(df_combined) <- c('hh_type', 'hh_migration_background', 'hh_age')
...
df_combined <- merge(df_combined, df, by.x = 'hh_age', by.y = 'type')
df_combined <- df_combined %>%
  rename('income_1_10_age' = 'income_1_10%',
         'income_2_10_age' = 'income_2_10%',
         'income_3_10_age' = 'income_3_10%',
         'income_4_10_age' = 'income_4_10%',
         'income_5_10_age' = 'income_5_10%',
         'income_6_10_age' = 'income_6_10%',
         'income_7_10_age' = 'income_7_10%',
         'income_8_10_age' = 'income_8_10%',
         'income_9_10_age' = 'income_9_10%',
         'income_10_10_age' = 'income_10_10%')

df_combined$income_1_10 <- df_combined$income_1_10_type * df_combined$income_1_10_migration * df_combined$income_1_10_age
df_combined$income_2_10 <- df_combined$income_2_10_type * df_combined$income_2_10_migration * df_combined$income_2_10_age
df_combined$income_3_10 <- df_combined$income_3_10_type * df_combined$income_3_10_migration * df_combined$income_3_10_age
df_combined$income_4_10 <- df_combined$income_4_10_type * df_combined$income_4_10_migration * df_combined$income_4_10_age
df_combined$income_5_10 <- df_combined$income_5_10_type * df_combined$income_5_10_migration * df_combined$income_5_10_age
df_combined$income_6_10 <- df_combined$income_6_10_type * df_combined$income_6_10_migration * df_combined$income_6_10_age
df_combined$income_7_10 <- df_combined$income_7_10_type * df_combined$income_7_10_migration * df_combined$income_7_10_age
df_combined$income_8_10 <- df_combined$income_8_10_type * df_combined$income_8_10_migration * df_combined$income_8_10_age
df_combined$income_9_10 <- df_combined$income_9_10_type * df_combined$income_9_10_migration * df_combined$income_9_10_age
df_combined$income_10_10 <- df_combined$income_10_10_type * df_combined$income_10_10_migration * df_combined$income_10_10_age
